...
import ru.ifmo.droid2016.filesdbdemo.R;
...
public class DemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (loadPrefsTask != null) {
            ...
            DemoPreferences prefs = loadPrefsTask.getPrefernces();
            if (prefs != null) {
                onPrefsLoaded(prefs);
            }
    ...
    protected void onPrefsLoaded(DemoPreferences prefs) {
    ...
    static class LoadPrefsTask extends AsyncTask<Void, Void, DemoPreferences> {

        private final Context context;
        private DemoActivity activity;
        private DemoPreferences prefs;
        ...
        DemoPreferences getPrefernces() {
            return prefs;
        }

        @Override
        protected DemoPreferences doInBackground(Void... params) {
            Log.d(TAG, "start loading preferences...");
            DemoPreferences prefs = new DemoPreferences(context);
            prefs.awaitLoaded();
        ...
        @Override
        protected void onPostExecute(DemoPreferences prefs) {
            this.prefs = prefs;
            if (activity != null) {
